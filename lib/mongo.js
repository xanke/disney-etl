...
// 乐园日历
exports.DsCalendar = mongolass.model('Ds_Calendar')
exports.DsCalendar.index({ date: 1, local: 1 }).exec()
...
// 售票量
exports.DsTicket = mongolass.model('Ds_Ticket')
exports.DsTicket.index({ date: 1, local: 1 }).exec()
// DISNEY-ETL
...
// 乐园统计
exports.DsOperate = mongolass.model('Ds_Operate')
exports.DsOperate.index({ date: 1, local: 1, type: 1 }).exec()
// exports.DsCount.index({ id: 1 }).exec()
